...
import { BasicQuestCard, BasicQuestCardWithDescription } from '../../components/questcard.jsx';
...
<div className="my-4 flex justify-between items-center flex-wrap">
    <BasicQuestCardWithDescription
        quest={{
            title: "Blacksmith Craft",
            description: "Yotra needs help collecting and smelting iron ores."
        }}
    />
    <BasicQuestCardWithDescription
        quest={{
            title: "Wolf Hides",
            description: "Yotra asked me to collect 3 wolf hides for her so she could sew armors from them."
        }}
    />
</div>
